 ...
 * срока действия детерминирована, через год все будет норм работать. Граница проверяется отдельно:
 * код, истекающий ровно сегодня, ещё действует. Для null и кода с пробелами репозиторий не должен вызываться вовсе.
 */
